...
namespace ShoppingCart.API.Migrations
{
    ...
    [Migration("20221203173241_AlterForeignKeys")]
    partial class AlterForeignKeys
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShoppingCart.API.Models.ShoppingCartDetailsModel", b =>
                {
                    ...
                    b.Property<Guid?>("ShoppingCartHeaderModelId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShoppingCartHeaderModelId");
            ...
            modelBuilder.Entity("ShoppingCart.API.Models.ShoppingCartDetailsModel", b =>
                {
                    b.HasOne("ShoppingCart.API.Models.ShoppingCartHeaderModel", null)
                        ...
                        .HasForeignKey("ShoppingCartHeaderModelId");
                });
